...
export const APPLIES_ON_DEFAULT_FACTORY_PARAMETERS = ['parameter', 'default_factory_parameter'];
...
export const APPLIES_ON_ALL_BLOCKS = ['enum', 'enum_value', 'class', 'factory', 'parameter'];
/**
