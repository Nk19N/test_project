import { ObjectTypeDefinitionNode, InputObjectTypeDefinitionNode, UnionTypeDefinitionNode, EnumTypeDefinitionNode, FieldDefinitionNode, InputValueDefinitionNode } from 'graphql';
import { TypeNamePattern, TypeName, FieldNamePattern, Pattern } from './pattern.cjs';
/**
 * @name FlutterFreezedPluginConfig
 * @description configure the `flutter-freezed` plugin
 */
export declare type FlutterFreezedPluginConfig = {
    /**
 ...
 */
export declare type AppliesOn = 'enum' | 'enum_value' | 'class' | 'factory' | 'default_factory' | 'named_factory' | 'union_factory' | 'merged_factory' | 'parameter' | 'default_factory_parameter' | 'named_factory_parameter' | 'union_factory_parameter' | 'merged_factory_parameter';
export declare const APPLIES_ON_ENUM: readonly ["enum"];
export declare type AppliesOnEnum = (typeof APPLIES_ON_ENUM)[number];
export declare const APPLIES_ON_ENUM_VALUE: readonly ["enum_value"];
export declare type AppliesOnEnumValue = (typeof APPLIES_ON_ENUM_VALUE)[number];
export declare const APPLIES_ON_CLASS: readonly ["class"];
export declare type AppliesOnClass = (typeof APPLIES_ON_CLASS)[number];
export declare const APPLIES_ON_DEFAULT_FACTORY: readonly ["factory", "default_factory"];
export declare type AppliesOnDefaultFactory = (typeof APPLIES_ON_DEFAULT_FACTORY)[number];
export declare const APPLIES_ON_UNION_FACTORY: readonly ["factory", "named_factory", "union_factory"];
export declare type AppliesOnUnionFactory = (typeof APPLIES_ON_UNION_FACTORY)[number];
export declare const APPLIES_ON_MERGED_FACTORY: readonly ["factory", "named_factory", "merged_factory"];
export declare type AppliesOnMergedFactory = (typeof APPLIES_ON_MERGED_FACTORY)[number];
export declare type AppliesOnNamedFactory = AppliesOnUnionFactory | AppliesOnMergedFactory;
export declare const APPLIES_ON_FACTORY: string[];
export declare type AppliesOnFactory = AppliesOnDefaultFactory | AppliesOnNamedFactory;
export declare const APPLIES_ON_DEFAULT_FACTORY_PARAMETERS: readonly ["parameter", "default_factory_parameter"];
export declare type AppliesOnDefaultFactoryParameters = (typeof APPLIES_ON_DEFAULT_FACTORY_PARAMETERS)[number];
...
export declare type AppliesOnUnionFactoryParameters = (typeof APPLIES_ON_UNION_FACTORY_PARAMETERS)[number];
...
export declare type AppliesOnMergedFactoryParameters = (typeof APPLIES_ON_MERGED_FACTORY_PARAMETERS)[number];
export declare type AppliesOnNamedParameters = AppliesOnUnionFactoryParameters | AppliesOnMergedFactoryParameters;
...
export declare type AppliesOnParameters = AppliesOnDefaultFactoryParameters | AppliesOnNamedParameters;
export declare const APPLIES_ON_ALL_BLOCKS: readonly ["enum", "enum_value", "class", "factory", "parameter"];
export declare type DartIdentifierCasing = 'snake_case' | 'camelCase' | 'PascalCase';
...
export declare type ObjectType = ObjectTypeDefinitionNode | InputObjectTypeDefinitionNode;
export declare type ConfigOption = keyof FlutterFreezedPluginConfig;
export declare type FreezedOption = Extract<ConfigOption, 'copyWith' | 'equal' | 'immutable' | 'makeCollectionsUnmodifiable' | 'mutableInputs' | 'privateEmptyConstructor'>;
export declare type TypeFieldNameOption = Extract<ConfigOption, 'defaultValues' | 'deprecated' | 'escapeDartKeywords' | 'final' | 'fromJsonToJson'>;
export declare type MultiConstructorOption = FlutterFreezedPluginConfig['unionClass'];
export declare type UnionValueCase = 'FreezedUnionCase.camel' | 'FreezedUnionCase.pascal';
/**
